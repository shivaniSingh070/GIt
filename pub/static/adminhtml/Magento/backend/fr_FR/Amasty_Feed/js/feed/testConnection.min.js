define(['jquery'],function(jQuery){'use strict';var testButton=jQuery(".feed-connection-button"),messageSpan=jQuery(".feed-connection-result"),xhr=null;function changeButtonState(){if(jQuery("#feed_delivery_enabled").val()==="1"){testButton.show();messageSpan.show();}else{testButton.hide();messageSpan.hide();}}
