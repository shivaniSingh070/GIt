define(['jquery','underscore','mageUtils'],function($,_,utils){'use strict';return{cachedData:{},currentData:null,params:{},options:{},update:function(params,options){this.addParams(params);if(options){this.options=options;}
