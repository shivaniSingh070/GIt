define(['jquery','mage/mage'],function($){'use strict';$.mage.Webapi=function(baseUrl,ajaxArgs){var validMethods;this.resource={uri:{base:'',api:'/webapi/rest'}};this.method={'create':'POST','update':'PUT','get':'GET','delete':'DELETE'};validMethods=[this.method.create,this.method.update,this.method.get,this.method['delete']];if(ajaxArgs&&typeof ajaxArgs!=='object'){throw'ajaxArgs expected to be object';}
