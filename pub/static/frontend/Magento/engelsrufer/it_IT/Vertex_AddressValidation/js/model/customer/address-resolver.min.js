define(['jquery','underscore'],function($,_){'use strict';return{addressFieldsForValidation:['city','postcode','street'],responseAddressData:{},formAddressData:{},resolveAddressDifference:function(responseAddressData,formAddressData){var differences=[],valid=[];this.responseAddressData=responseAddressData;this.formAddressData=formAddressData;if(this.invalidErrorResponse(responseAddressData)){return[];}
...
if(responseData[v]===null){return true;}});return false;}};});