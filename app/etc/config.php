...
return [
    'modules' => [
        ...
        'Mageplaza_Smtp' => 1,
        'Mollie_Payment' => 1,
        'Nwdthemes_CacheFix' => 1,
        'OlegKoval_RegenerateUrlRewrites' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Pixelmechanics_Agreements' => 1,
        'Pixelmechanics_AutoInvoiceMail' => 1,
        'Pixelmechanics_BreadCrumbs' => 1,
        'Pixelmechanics_CatalogOrder' => 1,
        'Pixelmechanics_CategoryAttribute' => 1,
        'Pixelmechanics_CheckoutSummary' => 1,
        'Pixelmechanics_ConfigurableSwatcher' => 1,
        'Pixelmechanics_CustomerAttribute' => 1,
        'Pixelmechanics_Engelsrufer' => 1,
        'Pixelmechanics_ExportOrder' => 1,
        'Pixelmechanics_ImportProduct' => 1,
        'Pixelmechanics_LowestPrice' => 1,
        'Pixelmechanics_MarkerIO' => 0,
        'Pixelmechanics_Mostviewed' => 1,
        'Pixelmechanics_OrderAttribute' => 1,
        'Pixelmechanics_Paypal' => 1,
        'Pixelmechanics_ProductFilter' => 0,
        'Pixelmechanics_Recaptcha' => 1,
        'Pixelmechanics_UrlRewrite' => 1,
        'Pixelmechanics_User' => 1,
        'Sebwite_Sidebar' => 1,
        'SendCloud_SendCloud' => 1,
        'Staempfli_RebuildUrlRewrite' => 1,
        'Strategery_Infinitescroll' => 1,
        'StripeIntegration_Payments' => 0,
        'Temando_ShippingRemover' => 1,
        'ThankIT_ConfigurableWizard' => 1,
        'Tigren_Ajaxsuite' => 1,
        'Tigren_Ajaxcart' => 1,
        'Tigren_Core' => 1,
        'TradeTracker_Connect' => 1,
        'Ulmod_OrderImportExport' => 1,
        'Vertex_Tax' => 1,
