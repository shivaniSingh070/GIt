...
{
    /**	
    * Add the Math param to the constructor Params for generate the unique KEY for idempotency keys	
    * PM PS, 07.05.2020, @link - https://trello.com/c/YRsO5Z46/89-2020-02-10-doppelabbuchungen-stripe-issues-with-credit-card	
    */	
    ...
    public function charge($order)
    {
        ...
        /**	
        * Add the Math param to the API params for idempotency keys	
        * PM PS, 07.05.2020, @link - https://trello.com/c/YRsO5Z46/89-2020-02-10-doppelabbuchungen-stripe-issues-with-credit-card	
        */	
            // Add the idempotent Requests to the Api params	
        $params["idempotency_key"] = $this->mathRandom->getUniqueHash();
