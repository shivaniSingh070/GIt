    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mageplaza_blog_post_topic')) {
            $table = $installer->getConnection()
                ...
                ->addForeignKey(
                    $installer->getFkName('mageplaza_blog_post_topic', 'topic_id', 'mageplaza_blog_topic', 'topic_id'),
                    'topic_id',
        ...
        if (!$installer->tableExists('mageplaza_blog_post_category')) {
            $table = $installer->getConnection()
                ...
                ->addForeignKey(
                    $installer->getFkName('mageplaza_blog_post_category', 'post_id', 'mageplaza_blog_post', 'post_id'),
                    'post_id',
                    $installer->getTable('mageplaza_blog_post'),
                    'post_id',
                    Table::ACTION_CASCADE
