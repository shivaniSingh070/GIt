    ...
    return Element.extend({
        ...
        processData: function (data) {
            ...
            if (typeof range !== "undefined") {
                ...
                var totalAbandonedCartRate = totalAbandonedCarts/(totalAbandonedCarts+totalSuccessfulCarts);
                var totalRecapturedRate = totalCartCheckoutSent/totalEmailAbandonedSent;
