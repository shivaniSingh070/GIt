 ...
 define([
    ...
    "mage/mage"
         ...
         */
         _create: function() {
            this._on({
                ...
                'click #ves_insert_files': 'insertSelectedFiles',
        ...
        _selectNode: function(event, data) {
            ...
            this.element.find('#delete_files, #insert_files, #ves_insert_files').toggleClass(this.options.hidden, true);
        ...
        selectFile: function(event) {
            ...
            this.element.find('#delete_files, #insert_files, #ves_insert_files')
        ...
        insert: function(event) {
            ...
            if (!targetEl.length) {
                VesMediabrowserUtility.closeDialog();
