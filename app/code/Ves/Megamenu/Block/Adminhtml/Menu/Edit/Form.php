...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        if (!$model->getId()) {
            $model->setData("desktop_template", "horizontal");
            $model->setData("mobile_template", "0");
        }
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label'    => __('Alias'),
                'title'    => __('Alias'),
                'note'     => __('Input menu identifier key (alias) to call it on frontend. Default frontend menu Alias = menu-top'),
                'disabled' => $isElementDisabled,
                'required' => true
            ]
            );
