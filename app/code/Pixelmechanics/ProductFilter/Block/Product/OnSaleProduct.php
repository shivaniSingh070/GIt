<?php
/**
 * Overided mageplaze class to filter onsale products by price > 0, having image and enabled available later in all collections.
 * by Anoop Singh
...
class OnSaleProduct extends \Mageplaza\Productslider\Block\OnSaleProduct
{
