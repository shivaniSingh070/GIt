<?php
/**
 * Overided magento class to filter listing products by price > 0, having image and enabled available later in all collections.
 * by Anoop Singh
...
class ListProduct extends \Magento\Catalog\Block\Product\AbstractProduct implements IdentityInterface
{
    ...
    protected function _getProductCollection()
    {
        ...
        $firstCollection = clone $this->_productCollection;
        $secondCollection = clone $this->_productCollection;
        $finalCollection = $this->_productCollection;
