...
class Save extends \Pixelmechanics\CatalogOrder\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('pixelmechanics/catalogorder');
                        ...
                        $imagePath = 'pixelmechanics/catalogorder'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('pixelmechanics_catalogorder/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('pixelmechanics_catalogorder/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('pixelmechanics_catalogorder/*/new');
                }
                return;
            } catch (\Exception $e) {
