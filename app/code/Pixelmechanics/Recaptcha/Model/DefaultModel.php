...
/**
 * @author : HA 
 * @description : the client requested a change to a more user friendly version of Captcha. 
 * @chenges: add to construct the line 131 und 132
 * @date : 26.04.2022
 * @Trello: https://trello.com/c/HGYOiGuG/284-recaptcha-%C3%A4nderungsm%C3%B6glichkeit-captcha-art
 * 
 */
declare(strict_types=1);

namespace Pixelmechanics\Recaptcha\Model;
 ...
 * @since 100.0.2
 */
class DefaultModel extends \Magento\Captcha\Model\DefaultModel implements \Magento\Captcha\Model\CaptchaInterface
{
    /**
