...
namespace Pixelmechanics\ConfigurableSwatcher\Plugin\ConfigurableProduct\Block\Product\View\Type;

class Configurable {

    protected $helperData;

    public function __construct(\Pixelmechanics\Engelsrufer\Helper\Catalog $helperData) {
    ...
    \Magento\ConfigurableProduct\Block\Product\View\Type\Configurable $subject, $result
        ...
        // created json for simple product
...
*/ 
        ...
        foreach ($subject->getAllowProducts() as $simpleProduct) {
          // store product attribute values corresponding to product
