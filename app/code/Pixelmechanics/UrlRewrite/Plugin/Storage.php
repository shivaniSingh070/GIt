 ...
 */
namespace Pixelmechanics\UrlRewrite\Plugin;
...
class Storage extends \Magento\CatalogUrlRewrite\Model\Category\Plugin\Storage
{
    ...
    public function afterReplace(StorageInterface $object, array $result, array $urls)
    {
        ...
        if (count($toSave) > 0) {
            ...
            /** * fix the save category issue
             * * PM ha 31.03.2022 
             * * @link https://trello.com/c/m7Dg1Zor/307-problem-beim-umbenennen-und-speichern-von-kategorien#comment-6245860264a56b405394cba1
             *  */
