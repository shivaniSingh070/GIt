 ...
 */
namespace Lof\BasePrice\Block\Adminhtml\System\Config\Form\Field;

/**
 * Class ConversionMapping
 * @package Lof\BasePrice\Block\Adminhtml\System\Config\Form\Field
 */
class ConversionMapping extends \Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
{
    /**
     * @var \Lof\BasePrice\Block\Adminhtml\Form\Field\Unit
     */
     ...
     *
     * @return \Lof\BasePrice\Block\Adminhtml\Form\Field\Unit|\Magento\Framework\View\Element\BlockInterface
    ...
    protected function getProductUnitRenderer()
    {
        if (!$this->_productUnitRenderer) {
            $this->_productUnitRenderer = $this->getLayout()->createBlock(
                '\Lof\BasePrice\Block\Adminhtml\Form\Field\Unit',
                'product_unit',
