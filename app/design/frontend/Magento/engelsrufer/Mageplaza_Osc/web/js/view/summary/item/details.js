/**
 * Updated By NA, To add the getBulletPoints() to display the bullet points on the checkout review section. on 3.07.19
 *
 * NOTICE OF LICENSE
 *
...
define(
    ...
    function (_, $, Component, quote, updateItemAction, giftMessageItem, url, $t, modal) {
        ...
        return Component.extend({
            ...
            updateQtyTimeout: 0,
             /**
             * Get Bullet Points through the plugin by NA. 03.07.19
             */
            quoteItemData: quoteItemData,
                getValue: function(quoteItem) {
                    return quoteItem.name;
                },
                getBulletPoints: function(quoteItem) {
                    var item = this.getItem(quoteItem.item_id);
                    return item.bullet_point_1;
                },
