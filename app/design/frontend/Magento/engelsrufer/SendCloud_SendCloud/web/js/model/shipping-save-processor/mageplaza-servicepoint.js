define([
    ...
    return function (checkout) {
        checkout.payloadExtender = wrapper.wrapSuper(checkout.payloadExtender, function (payload) {
            this._super(payload);
            /**
             * Add Condition when there is no shipping method selection and the below if condition fails as cannot read property method_code of null
             * PM AY | 27 APRIL 2021
             */
            if (quote.shippingMethod() !== null && quote.shippingMethod().method_code === 'sendcloud') {
